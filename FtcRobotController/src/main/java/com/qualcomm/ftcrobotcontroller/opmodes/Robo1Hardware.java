 ...
 */
public class Robo1Hardware extends OpMode

{
...

    {
        ...
        try
        {
            v_motor_left_drive = hardwareMap.dcMotor.get ("left_motor");
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("left_motor");
        ...
        try
        {
            v_motor_right_drive = hardwareMap.dcMotor.get ("right_motor");
            v_motor_right_drive.setDirection (DcMotor.Direction.REVERSE);
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("right_motor");
            DbgLog.msg (p_exeception.getLocalizedMessage ());
        ...
        try
        {
            v_motor_left_arm = hardwareMap.dcMotor.get ("arm");
        }
        catch (Exception p_exeception)
        {
        ...
        try
        {
            v_servo_left_hand = hardwareMap.servo.get ("left_servo");
            v_servo_left_hand.setPosition (l_hand_position);
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("left_servo");
            DbgLog.msg (p_exeception.getLocalizedMessage ());
        ...
        try
        {
            v_servo_right_hand = hardwareMap.servo.get ("right_servo");
            v_servo_right_hand.setPosition (l_hand_position);
        }
        catch (Exception p_exeception)
        {
            m_warning_message ("right_servo");
            DbgLog.msg (p_exeception.getLocalizedMessage ());
